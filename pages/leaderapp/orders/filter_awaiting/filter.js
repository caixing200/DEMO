...
Page({
  ...
  onLoad:function(options){
    ...
    if (app.filters.orders_awaiting){
      this.setData({
        filter: app.filters.orders_awaiting
      });
    }
  },
  ...
  search:function(e){
    ...
    formData.deliverydateEnd = this.data.endDate;
    formData.deliverydateStart = this.data.startDate;
    console.log(JSON.stringify(formData));
    app.filters.orders_awaiting = formData;
