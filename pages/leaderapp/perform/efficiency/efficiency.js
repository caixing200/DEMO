...
Page({
  ...
  _createDeptCompletionRate: function () {
    ...
    app.admx.request({
      method: 'get',
      url: app.config.service.deptEfcAc.replace("{deptId}", that.data.dept.id),
      data: {
  ...
  _createDeptEmpCompletionRate: function () {
    ...
    app.admx.request({
      method: 'get',
      url: app.config.service.deptEmpEfcAc.replace("{deptId}", that.data.dept.id),
      data: {
        orderBy: orderBy
      },
      succ: function (res) {
  ...
  //部门任务完成率
  tabFinishedRate: function (e, filter) {
    var that = this;
    this.setData({
  ...
  filterOngoing: function () {
    wx.navigateTo({
      url: '../efficiency/filter/filter?startDate=' + this.data.beginDateFinishedRate + '&endDate=' + this.data.endDateFinishedRate + '&deptName=' + this.data.deptName + '&deptId=' + this.data.deptId,
    });
  },
