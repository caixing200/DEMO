...
Page({
  ...
  queryEmpQualifiedProductionPie: function () {
    ...
    app.admx.request({
      method: 'get',
      //写链接
      url: app.config.service.queryEmpQualifiedProductionPie.replace("{employeeId}", that.data.employeeId),
      //设置时间
      data: {
  ...
  queryEmpQualifiedProductionHistogram() {
    ...
    app.admx.request({
      method: 'get',
      url: app.config.service.queryEmpQualifiedProductionHistogram.replace("{employeeId}", that.data.employeeId),
      //设置时间
      data: {
        beginDate: this.data.beginDate,
        endDate: this.data.endDate
  ...
  tabFinishRate: function (e, filter) {
    ...
    wx.redirectTo({
      url: '../pepperform/pepperform?empId=' + that.data.employeeId + '&&beginDate=' + that.data.beginDate + '&&endDate=' + that.data.endDate,
    })
  },
  //生产效率
  ...
  filterOngoing: function () {
    wx.navigateTo({
      ...
      url: '../peppassedrate/filter/filter?startDate=' + this.data.beginDate + '&endDate=' + this.data.endDate + '&empName=' + this.data.employeeName + '&empId=' + this.data.employeeId,
    });
  },
})